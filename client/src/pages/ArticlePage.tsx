...
export default function ArticlePage() {
  ...
  useEffect(() => {
    ...
    document.title = article.title + ' | Leather Bags for Women';
    ...
    const pageUrl = 'https://leatherbagsforwomen.com/articles/' + article.slug;
    const catUrl = 'https://leatherbagsforwomen.com/' + article.categorySlug;
    ...
    articleScript.textContent = JSON.stringify({
      ...
      "author": { "@type": "Organization", "name": 'Leather Bags for Women' },
      "publisher": { "@type": "Organization", "name": 'Leather Bags for Women', "url": 'https://leatherbagsforwomen.com' },
      "url": pageUrl,
    });
