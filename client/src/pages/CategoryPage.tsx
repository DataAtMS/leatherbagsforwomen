...
const CATEGORY_SEO: Record<string, { metaTitle: string; metaDescription: string; h1: string; intro: string }> = {
  "crossbody-bags": { metaTitle: 'Crossbody Bags | Leather Bags for Women', metaDescription: 'Browse 0 articles about crossbody bags on Leather Bags for Women.', h1: 'Crossbody Bags', intro: 'Browse 0 articles about crossbody bags on Leather Bags for Women.' },
  "tote-bags": { metaTitle: 'Tote Bags | Leather Bags for Women', metaDescription: 'Browse 0 articles about tote bags on Leather Bags for Women.', h1: 'Tote Bags', intro: 'Browse 0 articles about tote bags on Leather Bags for Women.' },
  "sling-bags": { metaTitle: 'Sling Bags | Leather Bags for Women', metaDescription: 'Browse 0 articles about sling bags on Leather Bags for Women.', h1: 'Sling Bags', intro: 'Browse 0 articles about sling bags on Leather Bags for Women.' }
};
...
export default function CategoryPage() {
  ...
  useEffect(() => {
    ...
    const pageUrl = 'https://leatherbagsforwomen.com/' + slug;
    ...
    script.textContent = JSON.stringify({
      ...
      "breadcrumb": {
        "@type": "BreadcrumbList",
        "itemListElement": [
          { "@type": "ListItem", "position": 1, "name": "Home", "item": 'https://leatherbagsforwomen.com' },
